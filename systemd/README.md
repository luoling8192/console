# Systemd service for FST Console
...
- Download the binary. Find the relevant links for the binary https://github.com/luoling8192/console#binary-releases.
...
```
( cd /etc/systemd/system/; curl -O https://raw.githubusercontent.com/luoling8192/console/master/systemd/minio-console.service )
```
