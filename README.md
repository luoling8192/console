...
![build](https://github.com/luoling8192/console/workflows/Go/badge.svg) ![license](https://img.shields.io/badge/license-AGPL%20V3-blue)

A graphical user interface for [FST](https://github.com/luoling8192/minio)
...
```
go install github.com/luoling8192/console/cmd/console@latest
```
...
Please follow console [Contributor's Guide](https://github.com/luoling8192/console/blob/master/CONTRIBUTING.md)
