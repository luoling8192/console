...
TAG ?= "luoling8192/console:$(BUILD_VERSION)-dev"
...
coverage:
	@(GO111MODULE=on go test -v -coverprofile=coverage.out github.com/luoling8192/console/api/... && go tool cover -html=coverage.out && open coverage.html)
