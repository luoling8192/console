...
We always provide security updates for the [latest release](https://github.com/luoling8192/console/releases/latest).
Whenever there is a security update you just need to upgrade to the latest version.

## Reporting a Vulnerability

All security bugs in [luoling8192/console](https://github,com/luoling8192/console) (or other minio/* repositories)
